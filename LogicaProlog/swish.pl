...
modelo([
    ...
    (
    (Segmento_2==papelCelulose, Segmento_1==energiaEletrica,(Segmento_3==bancos; Segmento_4==bancos; Segmento_5==bancos));
    (Segmento_3==papelCelulose, (Segmento_1==energiaEletrica; Segmento_2==energiaEletrica), (Segmento_4==bancos; Segmento_5==bancos));
    (Segmento_4==papelCelulose, (Segmento_1==energiaEletrica; Segmento_2==energiaEletrica; Segmento_3==energiaEletrica),  Segmento_5==bancos)
    ),
	...
	/*Em uma das pontas esta o analista que investe atrav´es da RC Investimentos.*/
    ...
    (
    (Corretora_1==cucaPactual, Segmento_1==medicamentos);
    (Corretora_2==cucaPactual, Segmento_2==medicamentos);
    (Corretora_3==cucaPactual, Segmento_3==medicamentos); 
    (Corretora_4==cucaPactual, Segmento_4==medicamentos); 
    (Corretora_5==cucaPactual, Segmento_5==medicamentos)
    ),
	...
	(
    (Corretora_5==cucaPactual, (Colete_4==azul; Colete_3==azul; Colete_2==azul;
    Colete_1==azul));
    (Corretora_4==cucaPactual, (Colete_3==azul; Colete_2==azul; Colete_1==azul));
    (Corretora_3==cucaPactual, (Colete_2==azul; Colete_1==azul));
    ...
    (
    (Corretora_1==cucaynvest, Colete_2==azul);
    (Corretora_2==cucaynvest, (Colete_1==azul; Colete_3==azul));
    (Corretora_3==cucaynvest, (Colete_2==azul; Colete_4==azul));
    (Corretora_4==cucaynvest, (Colete_3==azul; Colete_5==azul));
    (Corretora_5==cucaynvest, Colete_4==azul)
    ),
    
 	/*O segmento de Educacao e estudado pelo analista que esta em algum lugar a direita do homem de colete Verde.*/
    (
    (Colete_1==verde, (Segmento_2==educacao; Segmento_3==educacao; Segmento_4==educacao;
    Segmento_5==educacao));
    ...
    (
    (Retorno_5==20, (Colete_4==amarelo; Colete_3==amarelo; Colete_2==amarelo;
    Colete_1==amarelo));
    (Retorno_4==20, (Colete_3==amarelo; Colete_2==amarelo; Colete_1==amarelo));
    (Retorno_3==20, (Colete_2==amarelo; Colete_1==amarelo));
    ...
    (
    (Colete_5==azul, (Retorno_4==60; Retorno_3==60; Retorno_2==60;
    Colete_1==60));
    (Colete_4==azul, (Retorno_3==60; Retorno_2==60; Retorno_1==60));
    (Colete_3==azul, (Retorno_2==60; Retorno_1==60));
    (Colete_2==azul, Retorno_1==60)
    ),
    ...
    (
    (Retorno_5==50, (Colete_4==verde; Colete_3==verde; Colete_2==verde;
    Colete_1==verde));
    (Retorno_4==50, (Colete_3==verde; Colete_2==verde; Colete_1==verde));
    (Retorno_3==50, (Colete_2==verde; Colete_1==verde));
    ...
    (
    (Nome_1==felipe, Colete_2==verde);
    (Nome_2==felipe, Colete_3==verde);
    (Nome_3==felipe, Colete_4==verde);
    (Nome_4==felipe, Colete_5==verde)
    ),
    ...
    (
    (Nome_1==tiago, Idade_2==trintaEcinco);
    (Nome_2==tiago, Idade_3==trintaEcinco);
    (Nome_3==tiago, Idade_4==trintaEcinco);
    (Nome_4==tiago, Idade_5==trintaEcinco)
    ),
    ...
    (
    (Colete_1==verde, (Idade_2==cinquenta; Idade_3==cinquenta; Idade_4==cinquenta;
    Idade_5==cinquenta));
    ...
    (
        (Colete_2==azul, Nome_1==bruce,(Idade_3==trintaEcinco; Idade_4==trintaEcinco; Idade_5==trintaEcinco));
        (Colete_3==azul, (Nome_1==bruce; Nome_2==bruce), (Idade_4==trintaEcinco; Idade_5==trintaEcinco));
        (Colete_4==azul, (Nome_1==bruce; Nome_2==bruce; Nome_3==bruce),  Idade_5==trintaEcinco)
    ).
